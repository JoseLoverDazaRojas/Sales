namespace Sales.API.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1113628003", "Jose", "Daza", "josel8485@gmail.com", "313 644 9685", "Carrrera 18", "JoseLoverDazaRojas1.jpeg", UserType.Admin);
            await CheckUserAsync("1113628004", "Jose", "Daza", "josel8485@hotmail.com", "313 644 9685", "Carrrera 18", "JoseLoverDazaRojas2.jpeg", UserType.User);
        ...
        private async Task<User> CheckUserAsync(string document, string firstName, string lastName, string email, string phone, string address, string image, UserType userType)
        {
            ...
            if (user == null)
            {
                var city = await _context.Cities.FirstOrDefaultAsync(x => x.Name == "Palmira");
                if (city == null)
                {
